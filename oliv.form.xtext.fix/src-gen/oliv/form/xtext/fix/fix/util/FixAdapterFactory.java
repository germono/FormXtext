...
public class FixAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected FixSwitch<Adapter> modelSwitch =
    new FixSwitch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link oliv.form.xtext.fix.fix.Model <em>Model</em>}'.
   * <!-- begin-user-doc -->
