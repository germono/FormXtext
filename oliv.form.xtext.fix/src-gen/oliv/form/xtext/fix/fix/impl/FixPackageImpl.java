...
public class FixPackageImpl extends EPackageImpl implements FixPackage
{
   ...
   * @see oliv.form.xtext.fix.fix.FixPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private FixPackageImpl()
  {
    super(eNS_URI, FixFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link FixPackage#eINSTANCE} when that field is accessed.
  ...
  {
    if (isInited) return (FixPackage)EPackage.Registry.INSTANCE.getEPackage(FixPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredFixPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    FixPackageImpl theFixPackage = registeredFixPackage instanceof FixPackageImpl ? (FixPackageImpl)registeredFixPackage : new FixPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theFixPackage.createPackageContents();

    // Initialize created meta-data
    theFixPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theFixPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(FixPackage.eNS_URI, theFixPackage);
    return theFixPackage;
  }
